function step3c_MVPA_acoustic_crossnobis_xclass_cv(Sample,HomeDir,Response,roi_name,glm_name)
...
% First Version: Basil Preisig 03-03-2021
...
%     cfg.verbose = 2; % set 1, if you want all information to be printed on screen
    ...
    idx_reg_stimuli=find((contains(regressor_names(1,:),'da_DA') | ...
        ...
        contains(regressor_names(1,:),['amb_' Response])) & ... 
    ...
    labels(contains(labelnames,'highF3'))=1;
    labels(contains(labelnames,'lowF3'))=2;
    ...
    cfg.results.dir = fullfile(HomeDir,participant_id,['MVPA_acoustic_' Response '_crossnobis_xclass_cv']);
