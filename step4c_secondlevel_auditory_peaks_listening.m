function step4c_secondlevel_auditory_peaks_listening(Sample,HomeDir)
...
% regions that responded significantly to auditory stimuli. 
...
OutDir=fullfile(HomeDir,'analyses','secondlevel_auditory_peaks_listening');
if exist(OutDir)==0
    mkdir(fullfile(HomeDir,'analyses'),'secondlevel_auditory_peaks_listening')   
end
cd(OutDir);
...
for s=1:numSubjects
    ...
    SubjConDir=fullfile(HomeDir,participant_id,'firstlevel_glm_listening_sS');
