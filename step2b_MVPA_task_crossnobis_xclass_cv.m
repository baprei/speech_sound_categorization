function step2b_MVPA_task_crossnobis_xclass_cv(Sample,HomeDir,roi_name,glm_name)
...
for iSubj=1:length(Sample)
    ...
    cfg.results.dir = fullfile(HomeDir,participant_id,'MVPA_task_crossnobis_xclass_cv');
