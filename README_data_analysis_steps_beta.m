...
HomeDir='/p01-hdd/dsa/baprei-srv/Documents/RDC_3011204_MVPA';
...
% add marsbar
addpath /p01-hdd/dsa/baprei-srv/local_software/spm12/toolbox/marsbar

%cbrewer
addpath /p01-hdd/dsa/baprei-srv/local_software/cbrewer 

%mseb
addpath '/p01-hdd/dsa/baprei-srv/local_software/mseb'

% add toolbox decoding toolbox
toolboxRoot = '/p01-hdd/dsa/baprei-srv/local_software/decoding_toolbox_v3.997'; addpath(genpath(toolboxRoot));
...
% Supplemental plot of the psychometric curves
supplemental_plot_psychometry(HomeDir,Sample)
...
supplemental_plot_behavioral_data(HomeDir,Sample)
...
parfor iSubj=2:size(Sample,1)   
    %step2a_firstlevel_glm_task_nS(Sample{iSubj},HomeDir)    
    supplemental_firstlevel_glm_task_nS(Sample{iSubj},HomeDir) 
end

% common brain mask for passive listening and task
%--------------------------------------------------------------------------------
glm_name={'firstlevel_glm_task_nS','firstlevel_glm_listening_nS'};
glm_name={'supplemental_firstlevel_glm_task_nS','firstlevel_glm_listening_nS'};
...
step2b_MVPA_task_crossnobis_xclass_cv_b(Sample,HomeDir,roi_name,'supplemental_firstlevel_glm_task_nS');

% supplemental analysis Reviewer 3# point 2
%supplemental_MVPA_task_crossnobis_cv(Sample,HomeDir,roi_name,glm_name);
%supplemental_MVPA_task_crossnobis_cv_b(Sample,HomeDir,roi_name,'supplemental_firstlevel_glm_task_nS');
...
AnalysisName={'supplemental_MVPA_task_crossnobis_cv_b','supplemental_MVPA_task_crossnobis_cv_b'};
%AnalysisName={'MVPA_task_crossnobis_xclass_cv_b'};
...
% This script plots grouplevel data in MRIcroGL
...
% This script plots the data presented in Fig2B using MRIcroGL
