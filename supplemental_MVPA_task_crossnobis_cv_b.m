function supplemental_MVPA_task_crossnobis_cv_b(Sample,HomeDir,roi_name,glm_name)
...
for iSubj=1:length(Sample)
    ...
    idx_reg_stimuli=find((contains(regressor_names(1,:),'Amb')) & ...
...
%     cfg.files.xclass(contains(reg_stimuli(1,:),'Amb'))=2;
    ...
    cfg.results.dir = fullfile(HomeDir,participant_id,'supplemental_MVPA_task_crossnobis_cv_b');
